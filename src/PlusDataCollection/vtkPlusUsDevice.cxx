...
void vtkPlusUsDevice::GetValidParameterNames(std::vector<std::string>& parameterNames)
{
	parameterNames.clear();
}


PlusStatus vtkPlusUsDevice::TriggerParameterAnswers(const std::vector<std::string> parameterNamess)
{
